...
const users = [
    ...
    {name: "Pedroa", available: false},
    {name: "Marco", available: true},
...
const products = [
    ...
    {name: "Cheleira elétrica", price: 150 , category: "Eletro"},
...
console.log(
    `O nome do produto é ${productName}, custa R$${producPrice} e é da cor ${color}`
);
...
const shirt = new Product("Cmisa gola V", 20);
